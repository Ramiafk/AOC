...
test("blocks a role that lacks the route permission", async () => {
  ...
  const app = buildApp(application, contexts, new RouteAuthorizer(new InMemoryMembershipReader([membership])));
...
test("delivers invitation token out of band and accepts only verified recipient", async () => {
  ...
  const app = buildApp(application, contexts, new RouteAuthorizer(membershipRepository), memberships);
...
test("runs the CRM pipeline through HTTP v1 with tenant permissions",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,crm),headers={authorization:"Bearer crm-token"};
...
test("queues, dispatches and lists a branded notification through HTTP v1",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,undefined,notifications),headers={authorization:"Bearer notification-token"},customerId="cccccccc-cccc-4ccc-8ccc-cccccccccccc";
...
test("starts and advances a workflow through HTTP v1",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,undefined,undefined,workflows),headers={authorization:"Bearer workflow-token"};
...
test("creates, sends and accepts an exact quote through HTTP v1",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,undefined,undefined,undefined,quotes),headers={authorization:"Bearer quote-token"},customerId="cccccccc-cccc-4ccc-8ccc-cccccccccccc";
...
test("creates an order, invoice and partial payment through HTTP v1",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,finance),headers={authorization:"Bearer finance-token"};
...
test("runs a work order from check-in to vehicle release through HTTP v1",async()=>{
  ...
  const app=buildApp(application,contexts,new RouteAuthorizer(new InMemoryMembershipReader([membership])),undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,workshop),headers={authorization:"Bearer workshop-token"};
