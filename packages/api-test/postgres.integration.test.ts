...
test("PostgreSQL enforces RLS, composite tenant FKs and transactional outbox",{skip:!connectionString},async()=>{
  ...
  try{
    ...
    try{
      const t1="11111111-1111-4111-8111-111111111111",t2="22222222-2222-4222-8222-222222222222",o1="aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",o2="bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",c1="cccccccc-cccc-4ccc-8ccc-cccccccccccc";
      ...
      const visible=await db.query("SELECT id FROM organizations");assert.deepEqual(visible.rows.map(x=>x.id),[o1]);
