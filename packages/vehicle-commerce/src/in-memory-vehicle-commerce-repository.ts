...
import type { VehicleCommerceRepository, VehicleMediaProps, VehiclePreparationCheckProps, VehiclePublicationProps, VehicleStockItemProps } from "./vehicle-commerce.ts";

export class InMemoryVehicleCommerceRepository implements VehicleCommerceRepository {
  assets=new Set<string>(); sites=new Map<string,EntityId>(); items:VehicleStockItemProps[]=[]; publications:VehiclePublicationProps[]=[];checks:VehiclePreparationCheckProps[]=[];media:VehicleMediaProps[]=[];
